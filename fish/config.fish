if status is-interactive
    ...
    abbr vpn-ccn 'sudo openconnect 103.174.245.58 --servercert pin-sha256:KaXyhT+38uSFfjjiFIGF4dYRVdZmO5XtjMz+14atFFg= --user DhirajPatil --authgroup Connecting-Cyber-Networks --background --pid-file=/tmp/vpn-ccn.pid'
